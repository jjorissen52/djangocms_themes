...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'djangocms_themes', 'themes', 'binary', 'static'),
    os.path.join(BASE_DIR, 'djangocms_themes', 'themes', 'binary', 'assets'),
    os.path.join(BASE_DIR, 'events', 'static'),
    os.path.join(BASE_DIR, 'node_modules'),
)

DEFAULT_FILE_STORAGE = 'storages.backends.s3boto3.S3Boto3Storage'
AWS_STORAGE_BUCKET_NAME = config.get('djangocms_themes', 'storage_bucket_name')
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'djangocms_themes', 'themes', 'binary', 'templates'),
...
if config.get('local', 'host_name') in socket.gethostname():
    ...
    SCHEMA = config.get('djangocms_themes', 'db_schema')
    DATABASES = {
        'default': {
